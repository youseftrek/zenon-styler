...
const Gurantees = () => {
  return (
    <section className="relative my-24" id="guarantees">
      ...
      <div className="gap-2 grid grid-cols-2 md:grid-cols-4 mx-auto max-w-5xl">
        <div className="flex flex-col justify-center items-center gap-2 bg-card p-2 border rounded-md aspect-square">
          <Truck size={70} className="text-primary" />
          <div className="text-center">
            <h3 className="font-bold text-xl">شحن مجاني</h3>
        ...
        <div className="flex flex-col justify-center items-center gap-2 bg-card p-2 border rounded-md aspect-square">
          <Headset size={70} className="text-primary" />
          <div className="text-center">
            <h3 className="font-bold text-xl">خدمة ما بعد البيع</h3>
            <p className="text-muted-foreground text-xs">
        ...
        <div className="flex flex-col justify-center items-center gap-2 bg-card p-2 border rounded-md aspect-square">
          <ShieldCheck size={70} className="text-primary" />
          <div className="text-center">
            <h3 className="font-bold text-xl">ضمان المنتج</h3>
            <p className="text-muted-foreground text-xs">
        ...
        <div className="flex flex-col justify-center items-center gap-2 bg-card p-2 border rounded-md aspect-square">
          <HandCoins size={70} className="text-primary" />
          <div className="text-center">
            <h3 className="font-bold text-xl">الدفع عند الإستلام</h3>
            <p className="text-muted-foreground text-xs">
